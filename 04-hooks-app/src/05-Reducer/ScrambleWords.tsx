...
import { scrambledWordReducer, getIntialState } from './reeducer/ScrambleWordsReducer';
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <Card className="backdrop-blur-sm bg-white/80 border-0 shadow-xl">
          <CardContent className="p-8">
            ...
            {/* Guess Input */}
            <form onSubmit={()=>console.log('presionado')} className="mb-6">
